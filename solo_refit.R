...
# Create a layout with one column and five rows
...
#e_v
px_e_v = seq(min_x_prior(fx_e_v), max_x_prior(fx_e_v), length.out = 100000)
...
save(sample_l_a,        #sampled posterior
     ...
     mydata,
     file = paste("998_generated\\inla\\solo_refit_sample_",formatted_time,".RData",
                  sep = ""))
